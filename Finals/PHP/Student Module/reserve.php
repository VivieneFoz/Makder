...
<link rel="stylesheet" href="http://localhost/Makder/LoginPage/css/bootstrap.min.css">
<link rel="stylesheet" href="http://localhost/Makder/LoginPage/css/AdminLTE.min.css">
<link rel="stylesheet" href="http://localhost/Makder/LoginPage/css/font-awesome.min.css">
<link rel="stylesheet" href="http://localhost/Makder/LoginPage/css/Custom.css">
<link rel="stylesheet" href="http://localhost/Makder/LoginPage/css/dataTables.bootstrap.min.css">
<link rel="stylesheet" href="http://localhost/Makder/LoginPage/css/responsive.bootstrap.min.css">
<link rel="stylesheet" href="http://localhost/Makder/LoginPage/css/skins/_all-skins.min.css">
                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="http://localhost/Makder/LoginPage/imgs/avatar.png" class="user-image" alt="User Image">
                            <span class="hidden-xs"><!--Parang portal dapat to display yong name-->Student Name</span>
                        </a>
                        <ul class="dropdown-menu">
                            <li class="user-header">
                                <img src="http://localhost/Makder/LoginPage/imgs/avatar.png" class="img-circle" alt="User Image">
                                <p> Student Name
                                </p>
                                   <!--?php echo "<p>" .$row['fname']. "</p>" ??? STUDENT NAME DITO. NAKACONNECT DAPAT SA ID NUM PARANG PORTAL-->
                                
                            </li>
                            <li class="user-footer">
                                <div class="pull-right">
                                    <a href="http://localhost/Makder/LoginPage/index.php" class="btn btn-default btn-flat"><i class="fa fa-power-off"></i> Logout</a>
                                </div>
                            </li>
                        </ul>
                    </li>
     ...
     <div class="col-md-4">
        <div class="thumbnail">
          <a href="#" onclick="Order.AddItemName('1','Broom','1')">
                     <img src="http://localhost/Makder/LoginPage/imgs/walis.jpg" alt="Tidak ada foto" style="width:100%">
...
<div class="col-md-4">
    <div class="thumbnail">
      <a href="#" onclick="Order.AddMenu('2','StickBroom','1')">
                 <img src="http://localhost/Makder/LoginPage/imgs/stickbroom.jpg" alt="Tidak ada foto" style="width:100%">
...
<div class="col-md-4">
    <div class="thumbnail">
      <a href="#" onclick="Order.AddMenu('3','Dust Pan','1')">
                 <img src="http://localhost/Makder/LoginPage/imgs/dustpan.jpg" alt="Tidak ada foto" style="width:60%">
...
<div class="col-md-4">
    <div class="thumbnail">
      <a href="#" onclick="Order.AddMenu('4','Shovel', '1')">
                 <img src="http://localhost/Makder/LoginPage/imgs/shove.jpg" alt="Tidak ada foto" style="width:90%">
        <div class="caption text-center">
          <p>Shovel</p>
        </div>
      </a>
...
<div class="col-md-4">
    <div class="thumbnail">
      <a href="#" onclick="Order.AddMenu('5','Garden Shovel, '1')">
                 <img src="http://localhost/Makder/LoginPage/imgs/gardenshovel.jpg" alt="Tidak ada foto" style="width:60%">
...
<div class="col-md-4">
    <div class="thumbnail">
      <a href="#" onclick="Order.AddMenu('6','Watering Can','1')">
                 <img src="http://localhost/Makder/LoginPage/imgs/wateringcan.jpg" alt="Tidak ada foto" style="width:70%">
...
<div class="col-md-4">
    <div class="thumbnail">
      <a href="#" onclick="Order.AddMenu('7','Hivest Jacket','1')">
                 <img src="http://localhost/Makder/LoginPage/imgs/hivestjacket.jpg" alt="Tidak ada foto" style="width:50%">
...
<div class="col-md-4">
    <div class="thumbnail">
      <a href="#" onclick="Order.AddMenu('8','Bucket','1')">
                 <img src="http://localhost/Makder/LoginPage/imgs/bucket.jpg" alt="Tidak ada foto" style="width:80%">
...
<div class="col-md-4">
    <div class="thumbnail">
      <a href="#" onclick="Order.AddMenu('9','Water Dipper','1')">
                 <img src="http://localhost/Makder/LoginPage/imgs/waterdipper.jpg" alt="Tidak ada foto" style="width:100%">
...
<div class="col-md-4">
    <div class="thumbnail">
      <a href="#" onclick="Order.AddMenu('10','Gardening Scissor','1')">
                 <img src="http://localhost/Makder/LoginPage/imgs/gardeningScissor.jpg" alt="Tidak ada foto" style="width:100%">
    ...
    <div class="col-lg-4">
        <div class="box">
            <div class="box-header with-border">
                ...
                <div class="box-tools">
                    <label id="box-time"><?php echo "Date: " . date("m/d/Y") . "<br>" . "Time: " . date("h:i:sa");?>
                    </label>
                </div>
            </div><!-- /.box-header -->
