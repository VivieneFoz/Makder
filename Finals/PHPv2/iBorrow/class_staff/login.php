...
<head>
    ...
    <title>Class Staff Login Form | iBorrow </title>
...
if(isset($_POST["submit1"]))
{
    ...
    $count=0;
    $res=mysqli_query($link, "select * from staff_login where id_number='$_POST[id_number]' && password='$_POST[password]'");
